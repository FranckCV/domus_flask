document.addEventListener("DOMContentLoaded", () => {
    ...
    const galleryItems = document.querySelectorAll(".tarjetas .tarjeta");
    const limitPerPage = 2; // Número de elementos por página
    ...
    function showPage(page) {
        ...
        paginations.forEach(pagination => {
            ...
            prev.innerHTML = `<a class="page-link" href="#tarjetas"><i class="fa-solid fa-caret-left"></i></a>`;
            ...
            getPageList(totalPages, currentPage, paginationSize).forEach(item => {
                ...
                pageItem.innerHTML = item
                    ? `<a class="page-link" href="#tarjetas">${item}</a>`
            ...
            next.innerHTML = `<a class="page-link" href="#tarjetas"><i class="fa-solid fa-caret-right"></i></a>`;
